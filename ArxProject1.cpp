...
#include "resource.h"
#include <initguid.h>
#include "ArxProject1_i.h"
#include <afxdllx.h>
#include "ArxProject1_i.c"
#include "acadi_i.c"


//-----------------------------------------------------------------------------
class CArxProject1Module : public CAtlDllModuleT<CArxProject1Module> {

public :
	DECLARE_LIBID(LIBID_dpfArxProject1Lib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_ARXPROJECT1, "{AB206736-1CCF-4F1C-BCC8-1C0CE283768A}")
} ;

CArxProject1Module _AtlModule ;
